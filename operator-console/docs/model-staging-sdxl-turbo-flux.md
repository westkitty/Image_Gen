...
Only after a successful bounded smoke run should the app mark SDXL Turbo or Flux supported. SDXL base is supported through the dedicated bounded smoke proof and should stay labeled as proof-only, not full A1111 parity.
